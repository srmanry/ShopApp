...
class _PaginatedListWidgetState extends State<PaginatedListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      const SizedBox() : Center(child: Padding(
        padding: (_isLoading) ? const EdgeInsets.all(Dimensions.paddingSizeSmall) : EdgeInsets.zero,
        child: _isLoading ? SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,) : (widget.totalSize != null) ?
        InkWell(onTap: _paginate,
          child: Container(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeLarge),
